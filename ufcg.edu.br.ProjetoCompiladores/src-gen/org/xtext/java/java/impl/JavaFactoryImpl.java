...
public class JavaFactoryImpl extends EFactoryImpl implements JavaFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case JavaPackage.BIT_EXPRESSION: return createBit_Expression();
      case JavaPackage.LOGICAL_EXPRESSION: return createLogical_Expression();
      case JavaPackage.ARG_LIST: return createArg_List();
      case JavaPackage.NUMERIC_EXPRESSION: return createNumeric_Expression();
