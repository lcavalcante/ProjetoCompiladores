 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.java.java.Expression#getNumericExpression <em>Numeric Expression</em>}</li>
...
public interface Expression extends EObject
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Numeric Expression</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Numeric Expression</em>' containment reference.
   * @see #setNumericExpression(Numeric_Expression)
   * @see org.xtext.java.java.JavaPackage#getExpression_NumericExpression()
   * @model containment="true"
   * @generated
   */
  Numeric_Expression getNumericExpression();

  /**
   * Sets the value of the '{@link org.xtext.java.java.Expression#getNumericExpression <em>Numeric Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setNumericExpression(Numeric_Expression value);
   ...
   * @see #setLogicalExpression(Logical_Expression)
   * @see org.xtext.java.java.JavaPackage#getExpression_LogicalExpression()
   * @model containment="true"
   * @generated
   */
  Logical_Expression getLogicalExpression();
   ...
   * @generated
   */
  void setLogicalExpression(Logical_Expression value);
   ...
   * @see #setBitExpression(Bit_Expression)
   * @see org.xtext.java.java.JavaPackage#getExpression_BitExpression()
   * @model containment="true"
   * @generated
   */
  Bit_Expression getBitExpression();
   ...
   * @generated
   */
  void setBitExpression(Bit_Expression value);
