		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getTryAssignment_1(), "rule__Statement__TryAssignment_1");
					put(grammarAccess.getStatementAccess().getNameAssignment_2_0(), "rule__Statement__NameAssignment_2_0");
					put(grammarAccess.getStatementAccess().getStatementAssignment_2_2(), "rule__Statement__StatementAssignment_2_2");
					put(grammarAccess.getStatementAccess().getNameAssignment_3_2(), "rule__Statement__NameAssignment_3_2");
