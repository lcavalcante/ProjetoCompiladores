		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReturn_valueAccess().getAlternatives(), "rule__Return_value__Alternatives");
					...
					put(grammarAccess.getStatementAccess().getDoStatementAssignment_4(), "rule__Statement__DoStatementAssignment_4");
					put(grammarAccess.getStatementAccess().getWhileStatementAssignment_5(), "rule__Statement__WhileStatementAssignment_5");
					put(grammarAccess.getStatementAccess().getForStatementAssignment_6(), "rule__Statement__ForStatementAssignment_6");
					put(grammarAccess.getStatementAccess().getSwitchStatementAssignment_7(), "rule__Statement__SwitchStatementAssignment_7");
					put(grammarAccess.getStatementAccess().getTryAssignment_9(), "rule__Statement__TryAssignment_9");
					put(grammarAccess.getStatementAccess().getNameAssignment_10_0(), "rule__Statement__NameAssignment_10_0");
